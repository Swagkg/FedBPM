# GLOBAL PARAMETERS
import argparse
DATASETS = [ 'shakespeare', 'omniglot', 'femnist','cifar10']
TRAINERS = {'fedbpm': 'FedBPM',
            'fedavg_adv': 'FedAvgAdv'}

OPTIMIZERS = TRAINERS.keys()
MODEL_CONFIG = {
    'mnist.logistic': {'out_dim': 10, 'in_dim': 784},
    'femnist.Patt': {'num_classes': 62, 'image_size': 28},
    'omniglot.cnn': {'num_classes': 10, 'image_size': 32},
    'cifar10.Patt': {'num_classes': 10, 'image_size': 32},
