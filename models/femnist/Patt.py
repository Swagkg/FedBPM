...
class Model(nn.Module):
    def __init__(self, num_classes, image_size, dropout_rate=0.5, reduction_ratio=10):
        ...
        self.branch1 = self.create_branch(1, 32, 2, 0)
        self.branch2 = self.create_branch(32, 64, 3, 1)
        self.branch3 = self.create_branch(64, 128, 4, 1)
